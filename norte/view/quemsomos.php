<div class="container" id="faleconosco">
    <div>
        <div>
            <img src="img/lojai.png" alt="Foto" width="100%">
                ...
                <section class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-justify">
                            <div><img src="img/lojad.png" alt="Foto" width="100%"></div>
                        ...
                        <div class="col-sm-6 text-justify">
                            ...
                            <div><img src="img/lojag.png" alt="Foto" width="100%"></div>
                        </div>
                    </div>
                </section>
                <section class="col-sm-6">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <img src="img/lojac.png" alt="Foto" width="100%">
                        </div>
                        <div class="col-sm-4">
                            <img src="img/lojah.png" alt="Foto" width="100%">
                        </div>
                        <div class="col-sm-4">
                            <img src="img/lojae.png" alt="Foto" width="100%">
                        </div>
